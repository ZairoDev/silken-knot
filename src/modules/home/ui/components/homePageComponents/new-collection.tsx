export const NewCollection = () => {
    return (
        <div >
            ...
            <h2 className=" text-4xl mb-3 font-poppins">New Collection</h2>
            <span className="absolute  bottom-0 h-[2px] w-14  bg-yellow-800"></span>
            </div>
            </div>
            <div className="xl:flex  grid grid-cols-2 justify-center items-center gap-5 mx-8">
                <div className="flex flex-col items-end gap-4">
                    <div className="w-full h-full xl:w-[512px] xl:h-[558px] overflow-hidden">
                    ...
                    <div className = "w-full h-full xl:w-[363px] xl:h-[397px] overflow-hidden">
